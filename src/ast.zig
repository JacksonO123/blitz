...
fn parseSequence(allocator: Allocator, compInfo: *CompInfo) !*const AstNode {
...
fn parseStatement(allocator: Allocator, compInfo: *CompInfo) !?*const AstNode {
